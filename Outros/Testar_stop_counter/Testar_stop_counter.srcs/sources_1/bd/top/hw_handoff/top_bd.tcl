...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins Mux2_1_0/datain0]
  connect_bd_net -net counter_generic_0_led [get_bd_ports led] [get_bd_pins counter_generic_0/led] [get_bd_pins util_reduced_logic_0/Op1]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins Mux2_1_0/datain1] [get_bd_pins counter_generic_0/btnC] [get_bd_pins xlconstant_1/dout]
