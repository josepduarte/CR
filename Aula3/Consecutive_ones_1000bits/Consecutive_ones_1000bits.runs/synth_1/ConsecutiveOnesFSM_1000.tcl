...
read_vhdl -library xil_defaultlib C:/Users/jduarte/Documents/GitHub/CR/Aula3/Consecutive_ones_1000bits/Consecutive_ones_1000bits.srcs/sources_1/imports/new/ConsecutiveOnesFSM.vhd
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}

synth_design -top ConsecutiveOnesFSM_1000 -part xc7a100tcsg324-3


write_checkpoint -force -noxdef ConsecutiveOnesFSM_1000.dcp

catch { report_utilization -file ConsecutiveOnesFSM_1000_utilization_synth.rpt -pb ConsecutiveOnesFSM_1000_utilization_synth.pb }
