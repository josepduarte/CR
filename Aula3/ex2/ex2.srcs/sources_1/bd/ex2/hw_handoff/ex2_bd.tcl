...
CONFIG.CONST_WIDTH {8} \
  ...
  connect_bd_net -net Greatest_common_divisor_0_led [get_bd_pins Greatest_common_divisor_0/led] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net btnC_1 [get_bd_ports btnC] [get_bd_pins Greatest_common_divisor_0/btnC]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins BinToBCD16_0/clk] [get_bd_pins EightDispControl_0/clk] [get_bd_pins Greatest_common_divisor_0/clk]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins Greatest_common_divisor_0/sw]
  connect_bd_net -net xlconcat_0_dout [get_bd_ports led] [get_bd_pins BinToBCD16_0/binary] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins EightDispControl_0/leftL] [get_bd_pins EightDispControl_0/near_leftL] [get_bd_pins EightDispControl_0/near_rightL] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins BinToBCD16_0/request] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins BinToBCD16_0/reset] [get_bd_pins xlconstant_2/dout]
...
#  -string -flagsOSRD
preplace port btnC -pg 1 -y 340 -defaultsOSRD
...
preplace portBus led -pg 1 -y 490 -defaultsOSRD
preplace portBus seg -pg 1 -y 170 -defaultsOSRD
preplace inst EightDispControl_0 -pg 1 -lvl 3 -y 160 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 2 -y 60 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 1 -y 260 -defaultsOSRD
preplace inst xlconstant_2 -pg 1 -lvl 1 -y 180 -defaultsOSRD
preplace inst xlconstant_3 -pg 1 -lvl 2 -y 440 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 3 -y 430 -defaultsOSRD
preplace inst BinToBCD16_0 -pg 1 -lvl 2 -y 190 -defaultsOSRD
preplace inst Greatest_common_divisor_0 -pg 1 -lvl 2 -y 340 -defaultsOSRD
preplace netloc xlconstant_1_dout 1 1 1 150J
