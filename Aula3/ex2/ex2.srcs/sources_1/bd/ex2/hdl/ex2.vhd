...
architecture STRUCTURE of ex2 is
  ...
  component ex2_xlconstant_2_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component ex2_xlconstant_2_0;
  component ex2_xlconcat_0_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 7 downto 0 );
    In1 : in STD_LOGIC_VECTOR ( 7 downto 0 );
    dout : out STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  end component ex2_xlconcat_0_0;
  component ex2_xlconstant_3_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component ex2_xlconstant_3_0;
  component ex2_Greatest_common_divisor_0_1 is
  port (
    clk : in STD_LOGIC;
    btnC : in STD_LOGIC;
    sw : in STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  end component ex2_Greatest_common_divisor_0_1;
...
Greatest_common_divisor_0: component ex2_Greatest_common_divisor_0_1
     port map (
      btnC => btnC_1,
      clk => clk_1,
...
xlconcat_0: component ex2_xlconcat_0_0
     port map (
      In0(7 downto 0) => Greatest_common_divisor_0_led(7 downto 0),
      In1(7 downto 0) => xlconstant_3_dout(7 downto 0),
...
xlconstant_2: component ex2_xlconstant_2_0
     port map (
      dout(0) => xlconstant_2_dout(0)
    );
xlconstant_3: component ex2_xlconstant_3_0
     port map (
