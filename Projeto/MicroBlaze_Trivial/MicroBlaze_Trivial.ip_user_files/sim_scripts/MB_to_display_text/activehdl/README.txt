...
#
# Generated by export_simulation on Mon Apr 24 09:40:07 +0100 2017
#
################################################################################
...
switch to the './MB_to_display_text.sh' script.

./MB_to_display_text.sh -reset_run
...
./MB_to_display_text.sh -noclean_files

For more information on the script, please type './MB_to_display_text.sh -help'.
