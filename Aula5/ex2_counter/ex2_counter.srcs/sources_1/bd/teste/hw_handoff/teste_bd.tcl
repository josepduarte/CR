...
CONFIG.divFactor {100000000} \
  ...
  # Create instance: counter_between_x_and_y_1, and set properties
  set counter_between_x_and_y_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:counter_between_x_and_y:1.0 counter_between_x_and_y_1 ]
...
CONFIG.DOUT_WIDTH {8} \
  ...
  connect_bd_net -net ClkDividerN_0_clkOut [get_bd_pins ClkDividerN_0/clkOut] [get_bd_pins counter_between_x_and_y_1/clk]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins ClkDividerN_0/clkIn]
  connect_bd_net -net counter_between_x_and_y_1_count [get_bd_ports led] [get_bd_pins counter_between_x_and_y_1/count]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins counter_between_x_and_y_1/y] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins counter_between_x_and_y_1/x] [get_bd_pins xlslice_1/Dout]
...
preplace inst counter_between_x_and_y_1 -pg 1 -lvl 3 -y 160 -defaultsOSRD
...
preplace netloc xlslice_1_Dout 1 2 1 510
preplace netloc ClkDividerN_0_clkOut 1 2 1 520
preplace netloc counter_between_x_and_y_1_count 1 3 1 720
preplace netloc xlconstant_0_dout 1 1 1 NJ
preplace netloc clk_1 1 0 2 NJ 90 310J
preplace netloc sw_1 1 0 2 NJ 140 310
preplace netloc xlslice_0_Dout 1 2 1 520
levelinfo -pg 1 -30 250 420 620 910 -top -160 -bot 380
",
}
