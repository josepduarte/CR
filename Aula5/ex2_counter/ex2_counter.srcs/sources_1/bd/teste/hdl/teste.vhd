...
architecture STRUCTURE of teste is
  ...
  component teste_xlslice_1_0 is
  port (
    Din : in STD_LOGIC_VECTOR ( 15 downto 0 );
    Dout : out STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component teste_xlslice_1_0;
  component teste_counter_between_x_and_y_1_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component teste_counter_between_x_and_y_1_0;
  signal ClkDividerN_0_clkOut : STD_LOGIC;
  signal clk_1 : STD_LOGIC;
  signal counter_between_x_and_y_1_count : STD_LOGIC_VECTOR ( 7 downto 0 );
...
begin
  clk_1 <= clk;
  led(7 downto 0) <= counter_between_x_and_y_1_count(7 downto 0);
...
counter_between_x_and_y_1: component teste_counter_between_x_and_y_1_0
     port map (
      clk => ClkDividerN_0_clkOut,
      count(7 downto 0) => counter_between_x_and_y_1_count(7 downto 0),
      x(7 downto 0) => xlslice_1_Dout(7 downto 0),
      y(7 downto 0) => xlslice_0_Dout(7 downto 0)
    );
...
xlslice_1: component teste_xlslice_1_0
     port map (
      Din(15 downto 0) => sw_1(15 downto 0),
