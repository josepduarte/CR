...
################################################################
# This is a generated script based on design: ex1_top
#
...
CONFIG.divFactor {100000000} \
  ...
  set_property -dict [ list \
CONFIG.Byte_Size {9} \
CONFIG.Coe_File {../../../../../../vector16_8bits_random.coe} \
...
CONFIG.CONST_WIDTH {4} \
  ...
  connect_bd_net -net ClkDividerN_0_clkOut [get_bd_pins ClkDividerN_0/clkOut] [get_bd_pins CounterGenericNoClk_0/clk]
  connect_bd_net -net CounterGenericNoClk_0_count [get_bd_ports led] [get_bd_pins CounterGenericNoClk_0/count] [get_bd_pins blk_mem_gen_0/addra]
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins BinToBCD16_0/clk] [get_bd_pins ClkDividerN_0/clkIn] [get_bd_pins EightDispControl_0/clk] [get_bd_pins blk_mem_gen_0/clka]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins BinToBCD16_0/binary] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins BinToBCD16_0/reset] [get_bd_pins ClkDividerN_0/reset] [get_bd_pins CounterGenericNoClk_0/reset] [get_bd_pins CounterGenericNoClk_0/updown_n] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconcat_0/In1] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins BinToBCD16_0/request] [get_bd_pins CounterGenericNoClk_0/enable] [get_bd_pins xlconstant_2/dout]
...
preplace inst EightDispControl_0 -pg 1 -lvl 4 -y 160 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -y 250 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 1 -y 120 -defaultsOSRD
preplace inst xlconstant_2 -pg 1 -lvl 2 -y 180 -defaultsOSRD
preplace inst xlconstant_3 -pg 1 -lvl 3 -y 40 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 2 -y 70 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 4 -y 360 -defaultsOSRD
preplace inst BinToBCD16_0 -pg 1 -lvl 3 -y 230 -defaultsOSRD
preplace inst ClkDividerN_0 -pg 1 -lvl 2 -y 290 -defaultsOSRD
preplace inst CounterGenericNoClk_0 -pg 1 -lvl 3 -y 440 -defaultsOSRD
preplace netloc xlconstant_1_dout 1 1 1 140J
preplace netloc EightDispControl_0_segments 1 4 1 NJ
preplace netloc BinToBCD16_0_BCD0 1 3 1 630
preplace netloc xlconstant_2_dout 1 2 1 350
preplace netloc BinToBCD16_0_BCD1 1 3 1 620
preplace netloc ClkDividerN_0_clkOut 1 2 1 340
preplace netloc BinToBCD16_0_BCD2 1 3 1 610
preplace netloc BinToBCD16_0_BCD3 1 3 1 590
preplace netloc BinToBCD16_0_BCD4 1 3 1 580
preplace netloc xlconcat_0_dout 1 2 1 380
preplace netloc clk_1 1 0 4 NJ 300 150J 360 360J 360 600
preplace netloc xlconstant_0_dout 1 1 2 140 430 370
preplace netloc blk_mem_gen_0_douta 1 1 3 160 350 NJ 350 580J
preplace netloc CounterGenericNoClk_0_count 1 3 2 630 450 890J
preplace netloc EightDispControl_0_select_display 1 4 1 NJ
preplace netloc xlconstant_3_dout 1 3 1 610
levelinfo -pg 1 0 80 250 480 760 910 -top 0 -bot 520
",
}
