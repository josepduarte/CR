...
read_vhdl -library xil_defaultlib C:/Users/jduarte/Documents/GitHub/CR/Repository/mux2_1/mux2_1.srcs/sources_1/new/Mux2_1.vhd
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}

synth_design -top Mux2_1 -part xc7a100tcsg324-3


write_checkpoint -force -noxdef Mux2_1.dcp

catch { report_utilization -file Mux2_1_utilization_synth.rpt -pb Mux2_1_utilization_synth.pb }
